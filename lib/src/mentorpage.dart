        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Row(
                children: [
                  Image.asset("images/abida.png", width: 100),
                  Text(
                    "Mme ABIDA Malek",
                    style: TextStyle(
                      color: Colors.black,
            ...
            Container(
              ...
              child: Row(
                children: [
                  Image.asset("images/islem.png", width: 100),
                  Text(
                    "Mme CHAARI Islem",
                    style: TextStyle(
                      color: Colors.black,
            ...
            // Ajout des boutons pour chaque semaine
            ListView.builder(
              shrinkWrap: true,
              ...
              itemBuilder: (context, index) {
                return Container(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      print('Naviguer vers la semaine ${index + 1}');
                    },
                    child: Text(
                      'Week ${index + 1}',
